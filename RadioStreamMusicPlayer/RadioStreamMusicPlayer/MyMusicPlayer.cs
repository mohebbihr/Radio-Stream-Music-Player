...
namespace RadioStreamMusicPlayer
{
	...
	/// </summary>
	public partial class MyMusicPlayer : System.Windows.Forms.Form
	{
		// LOCAL VARS
		...
		public System.Windows.Forms.ToolTip toolTipbtnSceltaFile;
		public System.Windows.Forms.Button btnSceltaFile;
		...
		public System.Windows.Forms.TextBox textBoxGainDBValue;
		public System.Windows.Forms.Button buttonSetGain;
		public System.Windows.Forms.Button buttonZoom;
		public System.Windows.Forms.Button buttonStop;
		public System.Windows.Forms.ProgressBar progressBarPeak1Left;
		public System.Windows.Forms.ProgressBar progressBarPeak1Right;
		public System.Windows.Forms.ProgressBar progressBarPeak2Right;
		public System.Windows.Forms.Label label6;
		public System.Windows.Forms.ProgressBar progressBarPeak2Left;
		public System.Windows.Forms.Label label7;
		public System.Windows.Forms.TrackBar trackBarEffect;
		public System.Windows.Forms.Label labelLevel2;
		public System.Windows.Forms.Label label5;
		public System.Windows.Forms.Label labelLevel1;
		public System.Windows.Forms.Label label8;
		public System.Windows.Forms.Label label9;
		public System.Windows.Forms.Label label10;
		public System.Windows.Forms.CheckBox checkBoxLevel1Bypass;
		public System.Windows.Forms.CheckBox checkBoxLevel2Bypass;
		public System.Windows.Forms.CheckBox checkBoxCompressor;
		public System.Windows.Forms.CheckBox checkBoxDAmp;
		public System.Windows.Forms.TrackBar trackBarCompressor;
		public System.Windows.Forms.Label label11;
		public System.Windows.Forms.Label label13;
		public System.Windows.Forms.Label labelCompThreshold;
		public System.Windows.Forms.Label label12;
		public System.Windows.Forms.CheckBox checkBoxGainDither;
		public System.Windows.Forms.Label label15;
		public System.Windows.Forms.Label label16;
		public System.Windows.Forms.Label label19;
		public System.Windows.Forms.Label label20;
		public System.Windows.Forms.TrackBar trackBarStereoEnhancerWide;
		public System.Windows.Forms.CheckBox checkBoxStereoEnhancer;
		public System.Windows.Forms.TrackBar trackBarStereoEnhancerWetDry;
		public System.Windows.Forms.Label labelStereoEnhancer;
		public System.Windows.Forms.TrackBar trackBarGain;
		...
		public System.Windows.Forms.CheckBox checkBoxMono;
		public System.Windows.Forms.CheckBox checkBoxMonoInvert;
		public System.Windows.Forms.Label label24;
		public System.Windows.Forms.Label label25;
		public System.Windows.Forms.Label label26;
		public System.Windows.Forms.ToolTip toolTipIIRDelay;
		public System.Windows.Forms.TrackBar trackBarIIRDelay;
		public System.Windows.Forms.CheckBox checkBoxIIRDelay;
		public System.Windows.Forms.TrackBar trackBarIIRDelayWet;
		public System.Windows.Forms.TrackBar trackBarIIRDelayFeedback;
		public System.Windows.Forms.Label labelIIRDelay;
		public System.Windows.Forms.Label label27;
		public System.Windows.Forms.CheckBox checkBoxSoftSat;
		public System.Windows.Forms.TrackBar trackBarSoftSat;
		public System.Windows.Forms.Button buttonPause;
		public System.Windows.Forms.ComboBox comboBoxStreamCopy;
		public System.Windows.Forms.Label label29;
		public System.Windows.Forms.CheckBox checkBoxStreamCopy;
		public System.Windows.Forms.TrackBar trackBarSoftSatDepth;
		...
		private delegate void DelegateForStopChannnel();

		
		private void InitializeComponent(){
		
			this.toolTipbtnSceltaFile = new System.Windows.Forms.ToolTip();
			this.btnSceltaFile = new System.Windows.Forms.Button();
			...
			this.toolTipIIRDelay = new System.Windows.Forms.ToolTip();
			...
			// 
			// bottone per la selezione del file da riprodurre
			// 
			this.btnSceltaFile.Location = new System.Drawing.Point(10, 10);
			this.btnSceltaFile.Name = "Bottone di selezione file";
			this.btnSceltaFile.Size = new System.Drawing.Size(260, 23);
			this.btnSceltaFile.TabIndex = 0;
			this.btnSceltaFile.Text = "Seleziona un file da ascoltare";
			this.btnSceltaFile.Click += new System.EventHandler(this.btnSceltaFile_Click);
			//
			//tooltip del bottone scelta file
			//
			this.toolTipbtnSceltaFile.ToolTipTitle = "Scegli la Musica"; 
			this.toolTipbtnSceltaFile.UseFading = true; 
			this.toolTipbtnSceltaFile.UseAnimation = true; 
			this.toolTipbtnSceltaFile.IsBalloon = true; 
			this.toolTipbtnSceltaFile.ShowAlways = true; 
			this.toolTipbtnSceltaFile.AutoPopDelay = 5000; 
			this.toolTipbtnSceltaFile.InitialDelay = 1000; 
			this.toolTipbtnSceltaFile.ReshowDelay = 500; 
			this.toolTipbtnSceltaFile.SetToolTip(btnSceltaFile, "La tua canzone preferita di cubomusica!"); 
			// 
			// openFileDialog
			// 
			this.openFileDialog.Filter = "Audio Files (*.mp3;*.ogg;*.wav;*.wma)|*.mp3;*.ogg;*.wav;*.wma";
			...
			this.pictureBox1.Size = new System.Drawing.Size(710, 116);
			...
			this.buttonZoom.Location = new System.Drawing.Point(614, 146);
			...
			// toolTipIIRDelay
			// 
			this.toolTipIIRDelay.ToolTipTitle = "Imposta il Ritardo"; 
			this.toolTipIIRDelay.ToolTipIcon = System.Windows.Forms.ToolTipIcon.Info;
			this.toolTipIIRDelay.UseFading = true;
			this.toolTipIIRDelay.UseAnimation = true; 
			this.toolTipIIRDelay.IsBalloon = true; 
			this.toolTipIIRDelay.ShowAlways = true; 
			this.toolTipIIRDelay.AutoPopDelay = 5000;
			this.toolTipIIRDelay.InitialDelay = 1000; 
			this.toolTipIIRDelay.ReshowDelay = 500; 
			this.toolTipIIRDelay.SetToolTip(labelIIRDelay, "Determina il ritardo sull'esecuzione"); 
			// 
			// labelIIRDelay
			// 
			...
			this.labelIIRDelay.MouseHover += new System.EventHandler(this.labelIIRDelay_MouseHover);
			this.labelIIRDelay.MouseLeave += new System.EventHandler(this.labelIIRDelay_MouseLeave);
			// 
			// label27
			// 
        ...
        //added by mohebbihr for adding the cdstream to the outputMixerStream, I can't add more than 2 channels to it
        // so, when I want to add cd stream in the MyCD file, I have to remove this stream from the mixer channel
        public bool removePlayStream()
        {
            return  BassMix.BASS_Mixer_ChannelRemove(_stream);

        }

		private void btnSceltaFile_Click(object sender, System.EventArgs e)
		{
			this.openFileDialog.FileName = _fileName;
			if ( System.Windows.Forms.DialogResult.OK == this.openFileDialog.ShowDialog(this) )
			{
				if ( File.Exists(this.openFileDialog.FileName) )
				{
					_fileName = this.openFileDialog.FileName;
					this.btnSceltaFile.Text = Path.GetFileName(_fileName);
				}
				else
		...
		private void buttonPlay_Click(object sender, System.EventArgs e)
		{
			...
			if (_fileName != String.Empty)
			{
				...
				//_stream = Bass.BASS_StreamCreateURL(fromCubo,......)
				_stream = Bass.BASS_StreamCreateFile(_fileName, 0, 0, BASSFlag.BASS_SAMPLE_FLOAT | BASSFlag.BASS_STREAM_PRESCAN | BASSFlag.BASS_STREAM_DECODE );
				...
				if (_stream != 0){
					BassMix.BASS_Mixer_StreamAddChannel(RadioStreamMusicPlayer.outputMixerStream, _stream, BASSFlag.BASS_MIXER_DOWNMIX | BASSFlag.BASS_MIXER_FILTER | BASSFlag.BASS_MIXER_NORAMPIN);
                    
					//Bass.BASS_ChannelSetAttribute(_stream, BASSAttribute.BASS_ATTRIB_FREQ, 55000);
					//Bass.BASS_ChannelSetAttribute(_stream, BASSAttribute.BASS_ATTRIB_MUSIC_SPEED, 255);
					//Bass.BASS_ChannelSetAttribute(_stream, BASSAttribute.BASS_ATTRIB_MUSIC_BPM, 255);
					mySync = new SYNCPROC(EndSync);
					BassMix.BASS_Mixer_ChannelSetSync(_stream, BASSSync.BASS_SYNC_END, 0, mySync, IntPtr.Zero);		
				//if (_stream != 0 && Bass.BASS_ChannelPlay(RadioStreamMusicPlayer.outputMixerStream, false) )
				//{
		...
		{
			if (BassMix.BASS_Mixer_ChannelIsActive(_stream) == BASSActive.BASS_ACTIVE_PLAYING)
			{
				//Bass.BASS_ChannelPause(_stream);
				BassMix.BASS_Mixer_ChannelPause(_stream);
 
			}
			else
			{
				//Bass.BASS_ChannelPlay(_stream, false);
				BassMix.BASS_Mixer_ChannelPlay(_stream);
			}
		}
		...
		private void StopStream()
		{
			...
			BassMix.BASS_Mixer_ChannelRemove(_stream);
			Bass.BASS_StreamFree(_stream);
			_stream = 0;
			labelBtnForStop();
		}
		
		private  void labelBtnForStop() {
            	this.labelTime.Text = "Stopped";
				this.btnSceltaFile.Text = "Scegli un file da ascoltare(MP3, OGG or WAV..)";
				this.buttonStop.Enabled = false;
        ...
        {
            // BASS_SYNC_END Sync when a channel reaches the end
            _updateTimer.Stop();
            WF.RenderStop();
            DrawWavePosition(-1, -1);
			...
			Bass.BASS_StreamFree(_stream);
			_stream = 0;
			//Serve ad evitare il problema di Cross-thread operation
			if(labelTime.InvokeRequired)
				labelTime.BeginInvoke(new DelegateForStopChannnel(labelBtnForStop));
        }
		...
		private void timerUpdate_Tick(object sender, System.EventArgs e)
		{
			...
			if (BassMix.BASS_Mixer_ChannelIsActive(_stream) == BASSActive.BASS_ACTIVE_STOPPED )
			{
			...
			_tickCounter++;
			long pos = Bass.BASS_ChannelGetPosition(_stream,BASSMode.BASS_POS_BYTES); // position in bytes
			long len = Bass.BASS_ChannelGetLength(_stream,BASSMode.BASS_POS_BYTES); // length in bytes
			...
			if (_fullSpectrum)
				this.pictureBoxSpectrum.Image = _visModified.CreateSpectrumLinePeak(RadioStreamMusicPlayer.outputMixerStream, this.pictureBoxSpectrum.Width, this.pictureBoxSpectrum.Height, Color.Wheat, Color.Gold, Color.DarkOrange, Color.Black, 2, 1, 1, 13, false, true, false);
			else
				this.pictureBoxSpectrum.Image = _visModified.CreateWaveForm(RadioStreamMusicPlayer.outputMixerStream, this.pictureBoxSpectrum.Width, this.pictureBoxSpectrum.Height, Color.Green, Color.Red, Color.Gray, Color.Linen, 1, true, false, true);
		}
		...
		private void labelIIRDelay_MouseHover(object sender, EventArgs e)
        {
            this.toolTipIIRDelay.Active = true;
        }
        private void labelIIRDelay_MouseLeave(object sender, EventArgs e)
        {
            this.toolTipIIRDelay.Active = false;
        }
